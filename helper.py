...
class TextToSpeech:
    ...
    def __call__(
        ...
        for text in text_list:
            ...
            # CRITICAL FIX: Trim each chunk's wav to its exact duration before concatenation
            # This prevents accumulating latent chunk padding across multiple text chunks.
            trim_len = int(self.sample_rate * dur_onnx[0].item())
            wav = wav[:, :trim_len]
